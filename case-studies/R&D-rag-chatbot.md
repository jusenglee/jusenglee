...
R&D AI 챗봇 사업은 국가 R&D 정보 도메인에 특화된 질의응답 시스템을 구축하는 프로젝트였습니다.  
...
### 2.1. R&D 도메인은 일반 문서 검색보다 구조가 훨씬 복잡했습니다

R&D 도메인에서는 같은 “과제”라도 단일 시행 인스턴스를 가리키는 **ID**와, 연도별 시행 이력을 묶는 **NO**의 의미가 다릅니다.  
...
> 주의: 위 수치는 프로젝트 운영 환경 자체가 아니라, 공개 논문 풀텍스트 기반 초기 통합 검증 시험 환경 기준입니다.

### 6.2. 임베딩 모델 비교 평가

R&D AI 서비스 개선을 위한 비교 보고서에서는 **multilingual-e5-large** 와 **bge-m3** 를 동일 환경에서 평가했습니다.
...
이 프로젝트를 통해 R&D AI 챗봇은 단순한 문서 검색형 RAG에서 벗어나,
